...
const ENERGY_MOOD_OPTIONS = [
  ...
  { id: "crashes", label: "Energy crashes after meals or in the afternoon" },
  { id: "steady", label: "Pretty steady, with occasional dips" },
  { id: "energized", label: "Consistently energized and clear-headed" },
] as const;
...
export default function EnergyMoodScreen() {
  ...
  const handleSelect = (id: string, label: string) => {
    setSelectedId(id);
    saveOnboardingEnergyMood(label).then(() => {
      router.push("/onboarding/processed-food" as Href);
    });
  };
